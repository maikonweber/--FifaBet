...
Essas Condições Gerais de Utilização do ${ AppName } ("Condições Gerais") regulam o contrato ("Contrato") estabelecido entre Maikon Weber de Carvalho, residente na Rua Santarem , 55 , Jardim Oratório , Cep: 08330-350, Cidade de Maúa ,  Estado de São Paulo, ${Contratado}, e, de outro lado, a pessoa identificada na (Confirmação Contratual), representado por ${Contratado}, residente na {Rua ${Rua }, ${ Numero }, Bairro ${ Bairro }, Cep: ${ CEP }, Cidade de ${Cidade} Estado de ${Estado}.
...
“Senha” é o dado de acesso pessoal à Plataforma Observador de Resultados da Roleta bet365. É responsabilidade do Cliente manter este dado em sigilo e atualizado.
...
8.2. O CLIENTE poderá optar pelas Formas de Pagamento disponíveis na ${AppName} no momento da contratação.
...
8.6. o cancelamento do contrato, por qualquer motivo, gerará a imediata indisponibilidade de acesso do Cliente à ${AppName } bem como todas as suas funcionalidades.
...
const options = {
    ...
    header: {
        ...
        <img src="https://www.${AppName}.com.br/assets/images/logo.png" alt="${AppName}" style="width: 100%;">
        </div>`
    },
    footer: {
        height: '20mm',
...
pdf.create(html, options).toFile('./assets/pdf/termos-de-uso.pdf', function (err, res) {
